...
@app.post("/qa/")
async def login(question: str = Form()):

    # question = "How many programming languages does SiRi support?"
    context = "BLOOM has 176 billion parameters and can generate text in 46 languages natural languages and 13 programming languages, however SiRi has 500 billion parameters" # score 확률값, start와 end는 그 단서를 찾은 곳
